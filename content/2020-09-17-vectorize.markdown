...
Professor Lakoba's Numerical Analysis class was one of the most challenging courses I took
...
though I'm not sure how many of the kids these days can write a QR decomposition in C.
I'm kidding, because I don't know how to, but I sure as heck could write it in MATLAB (at one point)
...
Still, a lot of numerical code is written in pure Python,
...
This last one returns a different type of thing,
a list of dicts...not two arrays.
We can also import Pandas to stuff results into,
which gives us one more option for iteration:
